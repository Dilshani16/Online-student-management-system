          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="/student/index">View Student</a></li>
                    <li><a class="dropdown-item" href="/student/create">Add student</a></li>
                </ul>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/acadamic/acadamic">Academic</a>
            </li>
            <li class="nav-item">
