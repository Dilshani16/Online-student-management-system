        ...
        <div class="left-section">
            ...
            <div class="main-1 mt-5">
                ...
                <div class="mini1" onclick="showButtons(this)">
                    ...
                    <div class="action-buttons" style="display: none;">
                        <a href="{{route('dash.edit',$notice->id)}}" class="btn btn-success edit-btn">Edit</a>
                        <a href="{{route('dash.delete',$notice->id)}}" class="btn btn-danger delete-btn">Delete</a>
                    </div>
                </div>
                <br>
                @endforeach
            ...
            <div class="main-2 mt-5">
                ...
                <div class="mini2" onclick="showButtons(this)">
                    ...
                    <div class="action-buttons" style="display: none;">
                        <a href="{{route('dash.editAnnounce',$dash_announces->id)}}" class="btn btn-success edit-btn">Edit</a>
                        <a href="{{route('dash.deleteAnnounce',$dash_announces->id)}}" class="btn btn-danger delete-btn">Delete</a>
                    </div>
                </div><br>
                @endforeach
            ...
            <div class="mt-5">
                <a href="{{route('dash.create2')}}" class="btn btn-secondary">Manage -></a>
