        ...
        <div class="main-1 mt-5">
            ...
            <div class="mini1" onclick="showButtons(this)">
                ...
                <div class="action-buttons" style="display: none;">
                    ...
                    <a href="{{route('acadamic.delete', $photo->id)}}" class="btn btn-danger delete-btn">Delete</a>
                </div>
            </div>
            <br>
            @endforeach

            <a href="{{route('acadamic.add')}}" class="btn btn-success mt-3 mb-3"  style=" margin-left: 1100px;">ADD Documentary</a>
